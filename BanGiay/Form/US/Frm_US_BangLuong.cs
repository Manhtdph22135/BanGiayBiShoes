    ...
    public partial class Frm_US_BangLuong : UserControl
    {
        ...
        private void dgvHienThi_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                if (rowindex < 0 || rowindex >= dgvHienThi.Rows.Count)
                {
                    MessageBox.Show("Hãy chọn một hàng hợp lệ.", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }

                // Lấy giá trị từ DataGridView
                if (dgvHienThi.Rows[rowindex].Cells[1].Value == null)
                {
                ...
                if (obj == null)
                {
                    MessageBox.Show("Không tìm thấy dữ liệu tương ứng.", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
