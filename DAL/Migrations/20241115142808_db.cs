    ...
    public partial class db : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__CHUCVU__9FA9FD6AF4F3BB16", x => x.MACHUCVU);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__GIAOCA__7D3545CC3B0E7ACD", x => x.MAGIAOCA);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MAGIAY = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TENGIAY = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__GIAY__0C880C58B470AE44", x => x.MAGIAY);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__HINHTHUC__C3B2561F5CD7E7A3", x => x.MAHINHTHUCTHANHTOAN);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__KHACHHAN__30035C2FE0BCB0DC", x => x.MAKHACHHANG);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__TAIKHOAN__2ED8B5173C39F794", x => x.MATAIKHOAN);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MALUONG = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    THANGLAM = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__BANGLUON__D9BA4D002B7CA69C", x => x.MALUONG);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__CHATLIEU__80F939F8972B2020", x => x.MACHATLIEU);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__GIAOCANH__B0F1BCFDEE3F20F9", x => x.MAGIAOCANHANVIEN);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__KICHCO__7EDFFF297ED1ED8E", x => x.MAKICHCO);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__KIEUDANG__877F27F2941D28E9", x => x.MAKIEUDANG);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__MAUSAC__99E7A68F5C8C412D", x => x.MAMAUSAC);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__THUONGHI__B319F6381F879D7F", x => x.MATHUONGHIEU);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__UUDAI__3F58B4FDD2AE0E45", x => x.MAUUDAI);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__GIAYCHIT__196AD703AC96379A", x => x.MAGIAYCHITIET);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__HOADON__A4999DF58EE8A826", x => x.MAHOADON);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__HOADONCH__EF957FF0CEEA08EC", x => x.MAHOADONCHITIET);
                    table.ForeignKey(
